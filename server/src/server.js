...
console.log('MongoDB URI:', process.env.MONGODB_URI);  // This should log the URI if loaded properly
...
mongoose.set('strictQuery', true); // Ensuring mongoose uses strictQuery mode
